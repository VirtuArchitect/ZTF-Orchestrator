# Air-Gapped Upgrade Checklist - v1.7.0

1. Copy `ztf-update-v1.7.0.zip` to approved transfer media.
...
6. Confirm `/health` returns `{"status":"healthy","version":"1.7.0"}` after
   the container is recreated.
7. Open the UI and confirm the footer reports `ZeroTouch Orchestrator v1.7.0`.
