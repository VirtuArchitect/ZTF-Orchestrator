...
ARG ZTF_REF=v1.5.2
ARG ZTF_ORCHESTRATOR_VERSION=v1.7.11
...
ENV ZTF_ORCHESTRATOR_VERSION=${ZTF_ORCHESTRATOR_VERSION}
ENV ZTF_BUILD_COMMIT=${ZTF_BUILD_COMMIT}
ENV ZTF_BUILD_DATE=${ZTF_BUILD_DATE}
