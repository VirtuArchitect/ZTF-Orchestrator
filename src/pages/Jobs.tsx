                  ...
                  {job.diagnostics && (
                    <div className="diagnostics-callout rounded-lg border px-3 py-3">
                      ...
                      {job.diagnostics.likelyFix && (
                        <p className="diagnostics-callout-body mt-2 text-xs">{job.diagnostics.likelyFix}</p>
                      )}
                      {job.diagnostics.evidence && (
                        <p className="diagnostics-callout-evidence mt-1 text-xs font-mono break-words">{job.diagnostics.evidence}</p>
                      )}
                    </div>
                  )}
                  {job.trace && (
