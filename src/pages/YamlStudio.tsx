    ...
    >
      ...
      <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(360px,0.9fr)_minmax(420px,1.1fr)]">
        <div className="space-y-4">
          ...
          {(activeTab === 'global-config' || activeTab === 'upgrade-rule-pack' || activeTab === 'ztf2-iac') && (
            <section className="rounded-lg border border-border bg-surface p-4">
              <div className="mb-3 flex items-center gap-2">
                <FileCode size={16} className="text-nutanix-cyan" />
                <h2 className="text-sm font-semibold text-gray-100">
                  {activeTab === 'global-config' ? 'Global Config Template' : activeTab === 'ztf2-iac' ? 'ZTF 2.x input.yml Template' : 'Upgrade Rule Pack Template'}
                </h2>
              </div>
              <textarea
