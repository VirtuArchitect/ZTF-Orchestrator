...
```bash
sudo ZTF_ORCHESTRATOR_VERSION=v1.7.0 \
...
```bash
docker manifest inspect ghcr.io/virtuarchitect/ztf-orchestrator:v1.7.0
```
...
Current in-place container update packages are produced for `v1.7.1`. Use the
...
### Public v1.7.0 Appliance Image

A prebuilt standard AHV QCOW2 bundle for `v1.7.0` is generated by the AHV
...
cd appliance
VERSION=v1.7.0 \
ZTF_ORCHESTRATOR_VERSION=v1.7.0 \
...
packer build \
  -var "version=v1.7.0" \
  -var "ztf_orchestrator_version=v1.7.0" \
