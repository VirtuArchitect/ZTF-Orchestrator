...
Current ZTF-Orchestrator release for new evidence records: `v1.8.3`.
...
native_foundation:
  ...
  contract_version: native-foundation-adapter-contract/v1.8.3-readonly
