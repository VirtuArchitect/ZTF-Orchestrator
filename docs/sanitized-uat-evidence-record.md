...
Current ZTF-Orchestrator release for new evidence records: `v1.8.2`.
...
native_foundation:
  ...
  contract_version: native-foundation-adapter-contract/v1.8.2-readonly
