...
Current ZTF-Orchestrator source-tree release: `v1.7.11`.

> Historical evidence only.
> This document preserves a previous DEV_LAB validation path. Do not use it as
> the current installation, appliance update, or production validation guide.
...
Purpose: preserve the historical ZTF-Orchestrator v1.5.6 DEV_LAB Prism Element low-impact create/delete lifecycle runbook until the same validation is rerun for v1.7.11 after explicit lab-owner approval.
