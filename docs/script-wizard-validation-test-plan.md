...
1. Deploy ZTF-Orchestrator v1.7.7 with the latest offline package.
2. Confirm `/health` returns `healthy`.
3. Confirm the UI footer reports `ZeroTouch Orchestrator v1.7.7`.
...
```text
validation/YYYY-MM-DD-script-wizard-v1.7.7/
```
