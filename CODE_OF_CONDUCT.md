...
We are committed to making participation in ZTF-Orchestrator a respectful,
professional, and inclusive experience for everyone.

This project supports infrastructure automation, operational tooling, and
security-adjacent engineering work. Discussions should stay constructive,
...
If a report includes sensitive security details, credentials, exploit paths, or
information that could put users or systems at risk, do not post it publicly in
an issue or discussion.

Use the repository's security reporting process when available. If private
GitHub security reporting is not available, contact the project maintainer using
the contact information published on the maintainer's GitHub profile.

## Enforcement

Project maintainers are responsible for clarifying and enforcing this Code of
Conduct. Maintainers may remove, edit, or reject comments, commits, issues,
pull requests, discussions, or other contributions that are not aligned with
...
To report a Code of Conduct concern, contact the project maintainer privately
using the contact information published on the maintainer's GitHub profile.
...
requests, discussions, commits, documentation, community channels, and project
events. It also applies when an individual is representing the project in public
spaces.
